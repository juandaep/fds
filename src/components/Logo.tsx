  ...
  return (
    <Link
      ...
      className={classNames(
        "relative inset-0 w-[60px] h-[18px]",
        "lg:w-[96px] lg:h-[32px]"
      )}
    >
      <svg viewBox="0 0 96 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          className="fill-primary-500 dark:fill-primary-25 transition-colors delay-150 duration-100 ease-in"
        />
        <path
          d="M22.8278 23.6196V0H29.0802V19.3395H41.7867V23.6196H22.8278Z"
          className="fill-primary-500 dark:fill-primary-25 transition-colors delay-200 duration-150 ease-in"
        />
        <path
          ...
          className="fill-primary-500 dark:fill-primary-25 transition-colors delay-300 duration-200 ease-in"
        />
        <path
          ...
          className="fill-primary-500 dark:fill-primary-25 transition-colors delay-300 duration-300 ease-in"
        />
      </svg>
    </Link>
  );
