  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-2 text-default-600 dark:text-default-300">
        <div className="flex items-center text-lg -tracking-lg">
          Made with{" "}
        ...
        <div className="inline-flex items-center gap-4 text-xs font-bold uppercase -tracking-xs">
          ...
          <p className="text-sm font-normal -tracking-sm">&copy; {year} </p>
        </div>
      </div>
    </footer>
  );
